...
if($_POST){
    ...
    if (empty($errors)) {
        ...
        if ($result && mysqli_affected_rows($dbc) > 0) {
            if ( file_exists($_FILES["image"]["tmp_name"]) ) {
                //find old image and delte it
                unlink("../images/uploads/$originalName");
                unlink("../images/uploads/thumnails/$originalName");
            ...
            die("ERROR: Something went wrong. can't not update this entry");
        }
    }
}
                ...
                <div class="col">
                    <form action="./books/update.php?id=<?= $singleBook['id']; ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                          ...
                          <textarea class="form-control" name="description" rows="8" cols="80" name="bookDesc"placeholder="Description about the book">
                              <?php if($_POST){ echo $_POST['description']; } else { echo $singleBook['description']; } ?>
                          </textarea>
                        </div>

                        <div class="form-group">
                            <img src="./images/uploads/thumbnails/<?= $singleBook['image_name']; ?>" alt="book Cover">
